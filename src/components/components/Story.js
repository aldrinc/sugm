    ...
    <div className="row">
      <div className="col-md-5">
        <div className="over_story_cnt">
          ...
          <p>CLÉMENT is a modern art brand dedicated to promoting premium art goods for artists young and old. Inspired by aspiring artists' struggles, our goal is to equip new artists with the tools they need to stand out from the crowd. In addition to supporting the arts, we're committed to operational excellence through delivering product to your door quickly and with little hassle. </p>
          <ul>
      ...
      <div className="col-md-7 hide_mob">
        <div className="holyday_cnt">
          <div className="holyday_text_cnt">
            <h3>Modern beauty meets modern discounts.</h3>
